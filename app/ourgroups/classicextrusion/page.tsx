          ...
          >
            ...
            <div className="col-span-12 md:col-span-7">
              ...
              <motion.p
                ...
                transition={{ duration: 2.0 }}
              >
                Classic Extrusion LLC (Extrusion division) is one of the first extrusion plants IN U.A.E. and all the gulf region, and part of Elite Group of Companies since 2006.
              </motion.p>
              <motion.p
                className="text-[#484848] mb-6  text-justify md:pr-7"
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                Classic Extrusion LLC is ISO 9001:2008 certified company, with an annual capacity of 13,200 MT of high quality extrusions which contains two extrusion presses of 6” and 7”, with the latest material handling systems. The additional facilities include a most modern die correcting facility, ageing oven and all other ancillary equipment.
              </motion.p>
              <motion.p
                className="text-[#484848] mb-6 text-justify md:pr-7"
                initial={{ opacity: 0, y: 30 }}
                ...
                transition={{ duration: 1.4 }}
              >
            Classic Extrusion LLC manufactures all types of architectural profiles for glazing, curtain walls, facades, louver, shop fronts and the first company in Elite group to offer a certified thermal broken systems for windows (ECO 500®) in sliding & casement version, and structural curtain wall system (Elegant 65®).
              </motion.p>
              <motion.p
                className="text-[#484848] mb-6 text-justify md:pr-7"
                initial={{ opacity: 0, y: 30 }}
                ...
                transition={{ duration: 1.4 }}
              >
                At the same time non-architectural profiles are daily produced for sector such as scaffolding, advertisement, kitchen cabinet, insulation along with common and standard profiles. We also boast of being the licensed suppliers for Vistawall and Smart systems across the region.
            </motion.p>
            </div>
...
IMPRESSIVE INFRASTRUCTURE
        ...
        >
          At National Aluminium we take pride in constantly working hard to optimize our manufacturing capacity which recognizes the needs of our customers and stakeholders. The modern facility places us at a distinctive advantage.
        </motion.p>
      </div>
