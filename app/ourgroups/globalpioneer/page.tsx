...
import { WobbleCardSmall } from "@/components/wobble-card-small";
          ...
          >
            ...
            <div className="col-span-12 md:col-span-7">
              ...
              <motion.p
                ...
                transition={{ duration: 2.0 }}
              >
                Global Pioneer Aluminium Industries LLC it’s a specialized company in designing, engineering, fabrication, supply and installation of aluminium works and advanced curtain walling systems.
              </motion.p>
              <motion.p
              ...
              >
                Established since 1976 as pioneer in the aluminium industries in the region, since 2004 is member of Elite Group of Companies for which can be considered the in-house fabrication division of the group.
              </motion.p>
              <motion.p
                className="text-[#484848] text-justify md:pr-7"
                initial={{ opacity: 0, y: 30 }}
                ...
                transition={{ duration: 1.4 }}
              >
Based in Ajman, U.A.E., in a 26.000 square feet area we guarantee clients’ assistance and undertaking of turnkey projects, complying with the specifications, designs and the best of quality aluminium fabrication and related metal works.
              </motion.p>
            </div>
      ...
      >
        ...
        <motion.h1
          ...
          className="relative text-white text-xl md:text-2xl lg:text-4xl font-bold z-10 px-4"
        >
EXELLENCE IN OPERATION & SERVICE
        ...
        >
         Global Pioneer is involved in a workflow with the extrusion sister companies to operate in straight-chain afterwards the aluminium and rubber profiles manufacturing, and so offer the benefit of their knowledge and experience in the aluminium & glass along with the accessories industry. Hence the company is entitled to manage project in different emirates and so offer our specialization under a single license.
        ...
        <motion.p
          ...
          className="relative text-white text-sm md:text-base lg:text-lg mt-4 z-10 max-w-[800px] px-4"
        >
        Our commitment to technical excellence has led us to invest in machineries, shaping utensils, designing unit and whole infrastructure, enabling us to offer comprehensive engineering designs, quality craftsmanship to configure customers’ orders in advance.
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          >
            ...
            For the manufacturing of aluminium profiles we use a number of modern equipments. Quality control procedures are carried out throughout the fabrication and installation processes and are as per the Company’s quality plans, set by the management. A copy of the quality plan shall be submitted to the client or consultant upon request.     
           </p>
          </motion.div>
