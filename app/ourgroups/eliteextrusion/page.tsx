    ...
    <div>
      ...
      <div className="mx-auto  max-w-7xl">
        <div>
          ...
          <p className="mt-6">
            Elite Extrusion has one-of-a-kind aluminium extrusion manufacturing
            facility located in Ras Al Khaimah (U.A.E.) The plant covers an area
            of over 50,000 sqm with extrusion presses fully PLC controlled and
            100 meters long runout press table for natural cooling.
          </p>
          <p className="mt-4">
            Anodizing line, with pre & post-treatment, can reach an annual
            capacity of 7.500 MT for a standard application between 12 μm and 16
            μm. It can reach 25 μm on demand.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 max-w-7xl mx-auto p-6 items-center">
        ...
        <div className="col-span-8 border-[#E8D858] border-1 border-l-8 p-6">
          ...
          <p className="text-[#484848] leading-8">
            ...
            for doors, windows and kitchen cabinets, and they are available in a
      ...
      <div className="grid grid-cols-12 max-w-7xl mx-auto  items-center">
        {/* Left Column */}
      ...
      <WobbleCardDemo
        ...
        description="We provide aluminium profiles for various applications, including windows, doors, curtain walls, and more."
        listItems={[
