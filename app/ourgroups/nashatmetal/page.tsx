        ...
        >
          <div className="inline-block bg-[#023D68] bg-opacity-80 py-8 px-16 rounded w-[600px] mx-auto text-center">
            <h1 className="text-white font-semibold">
              {/* Elite */}
              <span className="text-xl md:text-4xl block">NASHAT METAL EMGINEERING LLC</span>
              {/* Extrusion LLC */}
              <span className="text-l md:text-2xl text-white text-opacity-70 block  font-medium">
          ...
          >
            ...
            <div className="col-span-12 md:col-span-7">
              ...
              >
                ...
                MODERN <br></br>
                EQUIPMENT - OUR<br></br> SUPPORT                </h2>
              </motion.div>
              <motion.p
                ...
                transition={{ duration: 2.0 }}
              >
Using high quality extrusion dies is a hallmark of Elite Group of Companies. Located in Ras Al Khaimah, Nashat Metal Engineering LLC is a division of this group which specializes in the manufacturing of top notch extrusion dies and tools.</motion.p>
              <motion.p
                className="text-[#484848] text-justify md:pr-7 mb-4"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 1.4 }}
              >
It is equipped with latest CNC wire cut machinery, precision lathes & grinding machines and other convectional machines with fully equipped and automated state of the art design unit with latest softwares.              </motion.p>
              <motion.p
                className="text-[#484848] text-justify md:pr-7 mb-2"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 1.4 }}
              >
This division has an annual production capacity of 3,600 Dies and caters to the urgent needs of the sister companies thereby increasing the service levels to uncomparable limits.</motion.p>
         </div>
            ...
            >
              <Image
                src={"/ourgroups/nashatmetal/image.png"}
                width={200}
                height={200}
                alt=""
      ...
      >
        ...
        >
STATE OF THE ART MACHINERY      </motion.h1>
        ...
        >
It houses a modern tool room capable of manufacturing high quality extrusion dies. Quality machinery, bolstered by innovation and a fully equipped design unit makes all the difference. This is how Nashat Metal Engineering LLC distinguishes itself from the rest.
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          >
            ...
            SERVICE LEVELS TO INCOMPARABLE LIMITS.            </h2>
          ...
          {/* Image Column */}
          <motion.div
            className="hidden md:col-span-4 md:block bg-[#023D68] p-6 text-white mb-8"
            initial={{ x: 50, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            viewport={{ once: true }}
            transition={{ duration: 2.0 }}
          >
            <div className="flex flex-col gap-4">
              <Image
                src="/ourgroups/nashatmetal/dies.png"
                alt=""
                width={350}
                height={180}
              ...
              />
              <Image
                src="/ourgroups/nashatmetal/dies1.png"
                alt=""
                width={350}
                height={180}
                className="shadow-lg -ml-10 border-3 border-[#E8D858]"
