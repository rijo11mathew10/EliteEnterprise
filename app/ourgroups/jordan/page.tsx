          ...
          >
            ...
            <div className="col-span-12 md:col-span-7">
              ...
              <motion.p
                ...
                transition={{ duration: 2.0 }}
              >
Jordan Aluminium is located about 80 kms from Amman, the capital of Jordan, and spread across an area of 15,000 square meters.              </motion.p>
              <motion.p
              ...
              >
It also houses a powder coating plant, with a production capacity of 12,000 MT per annum and an anodizing plant of 4,000 MT per annum which is scheduled to commence soon. We are also planning to set up a wood finish division too. Our plant is also equipped with the latest automated packing unit.
              </motion.p>
              <motion.p
                ...
                transition={{ duration: 1.4 }}
              >
The plant houses the most modern state of the art extrusion presses, engineered to extrude high quality aluminium profiles with an annual capacity of 20,000 MT. It includes a modern die correction station, ageing oven and other ancillary equipments.              </motion.p>
            </div>
            ...
            >
              <Image
                src={"/ourgroups/jordan/image.png"}
                width={200}
                height={200}
                alt=""
...
TOP NOTCH MACHINERY  
        ...
        >
The additional facilities that Jordan Aluminium offers include modern Die Correction Stations, ageing oven and ancillary equipment. It also houses a powder coating plant, with a production capacity of 12,000 MT per annum and an anodizing plant of 4,000 MT per annum.    
    </motion.p>
      </div>
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          >
            ...
            Every company is distinguished by its machinery. The new plant is being set up and production will commence shortly to meet the growing demands of the region.            </p>
