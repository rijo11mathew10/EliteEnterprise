  ...
  return (
    ...
    >
                ...
                >
                  ...
                  <div className="col-span-12 md:col-span-7 mt-12 md:mt-20">
                    ...
                    <motion.p
                      ...
                      transition={{ duration: 2.0 }}
                    >
                      Address: <a href="https://maps.app.goo.gl/ZYHzgCPEWsgTFmnX7?g_st=it" target="_blank" className="text-blue-500 hover:underline">X5CP+F28 - Dubai Investment Park - 2 - Dubai</a><br></br>
      ...
      Phone: 04 885 8101
                  ...
                  {/* Logo Column */}
                  <motion.a
                    href="https://maps.app.goo.gl/ZYHzgCPEWsgTFmnX7?g_st=it"
                    target="_blank"
                    ...
                    style={{
                      backgroundImage:
                        "url('/locationnalexco.jpg')", // Replace with your image path
                      backgroundSize: "cover", // Ensures the image completely fills the div
