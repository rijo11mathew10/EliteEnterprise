...
function page() {
  const sections = [
    { title: "ALUMINIUM COIL & SHEET", value: "25,000", unit: "Metric Tone" },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl mb-16">
        ...
        <div className="flex flex-col mx-auto pl-6">
          ...
          <motion.p
            ...
            transition={{ duration: 1.2, ease: "easeOut" }}
          >
            The coil coating process is the most efficient means of coating
            aluminum. It is a continuous, high-volume process that produces a
            consistent product. The aluminum substrate gets degreased,
            chemically pre-treated and coated. Typical paint system requirements
            are formability, scratch-resistance, appearance and weather ability.
          </motion.p>
          <motion.h3
                ...
                >
                  ...
                  <div className="col-span-12 md:col-span-7 mt-12 md:mt-20">
                    ...
                    <motion.p
                      ...
                      transition={{ duration: 2.0 }}
                    >
                      Address: <a href="https://maps.app.goo.gl/RHGfbDwm53FM4diN9?g_st=it" target="_blank" className="text-blue-500 hover:underline">E18 - Al Ghayl - Ras Al Khaimah</a><br></br>
      ...
      Phone: 07 258 9099
                  ...
                  {/* Logo Column */}
                  <motion.a
                    href="https://maps.app.goo.gl/RHGfbDwm53FM4diN9?g_st=it"
                    target="_blank"
