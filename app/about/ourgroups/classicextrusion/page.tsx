    ...
    >
      ...
      />
                      ...
                      >
                        ...
                        <div className="col-span-12 md:col-span-7 mt-12 md:mt-20">
                          ...
                          <motion.p
                            ...
                            transition={{ duration: 2.0 }}
                          >
                            Address: <a href="https://maps.app.goo.gl/jJU5C5L4WoAqSjof8?g_st=it" target="_blank" className="text-blue-500 hover:underline">7FJ2+FG8 - Maleha St - Industrial Area 17 - Industrial Area - Sharjah</a><br></br>
            ...
            Phone: 06 534 9550
                        ...
                        {/* Logo Column */}
                        <motion.a
                          href="https://maps.app.goo.gl/jJU5C5L4WoAqSjof8?g_st=it"
                          target="_blank"
                          ...
                          style={{
                            backgroundImage:
                              "url('/locationclassic.jpg')", // Replace with your image path
                            backgroundSize: "cover", // Ensures the image completely fills the div
                            backgroundPosition: "center", // Centers the image in the div
                            backgroundRepeat: "no-repeat", // Prevents the image from repeating
                          }}
