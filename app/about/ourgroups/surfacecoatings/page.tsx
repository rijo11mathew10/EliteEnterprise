...
function page() {
  return (
    <div>
        ...
        >
          <div className="inline-block bg-[#023D68] bg-opacity-80 py-4 px-8 rounded">
            <h1 className="text-white font-semibold">
              {/* Elite */}
              <span className="text-4xl md:text-7xl block">SURFACE COATINGS</span>
              {/* Extrusion LLC */}
      ...
      <motion.p
              ...
              >
                We offer three types of finish coating – powder coating, wood effect coating and anodizing. Having three powder coating plants, with two high capacity vertical powder coating line, to provide finishing in the variety of colours in RAL.
              </motion.p>
          ...
          >
            ...
            <div className="col-span-12 md:col-span-7">
              ...
              <motion.p
                ...
                transition={{ duration: 2.0 }}
              >
                    We have three powder coating plants, with two high capacity vertical powder coating unit, to provide finishing in the variety of colours in RAL colours. The unit is certified with Qualicoat.
              </motion.p>
              <motion.p
  ...
  <motion.div
      ...
      >
        <h3 className="text-2xl font-bold text-[#023D68] mb-8">WOOD CHAIN EFFECT FEATURES</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Materials */}
          <div>
            <h4 className="font-semibold text-[#023D68] mb-2">Materials</h4>
            <p className="text-[#484848]">The wood pattern coating can be cured and transferred to the surface of aluminum profiles or aluminum sheets under a temperature of 200-degree Celsius.</p>
          </div>

          {/* Cost Savings */}
          <div>
            <h4 className="font-semibold text-[#023D68] mb-2">Cost Savings</h4>
            <p className="text-[#484848]">Maintenance free will resume original effect simply by regular cleaning.</p>
          </div>

          {/* Durability */}
          <div>
            <h4 className="font-semibold text-[#023D68] mb-2">Durability</h4>
            <p className="text-[#484848]">Excellent weathering resistance performance, durable in all kinds of applications.</p>
          </div>

          {/* Effects */}
          <div>
            <h4 className="font-semibold text-[#023D68] mb-2">Effects</h4>
            <p className="text-[#484848]">The decorative effects of pictures, text and graphs, and all kinds of natural scenes can be of a wood material or marble character transmitted by the latest technology.</p>
          </div>

          {/* Environmental Friendliness */}
          <div>
            <h4 className="font-semibold text-[#023D68] mb-2">Environmental Friendliness</h4>
            <p className="text-[#484848]">The special decoration needs can be realized without using wood, meanwhile the products can be recycled.</p>
          </div>

          {/* Fields of Applications */}
          <div>
            <h4 className="font-semibold text-[#023D68] mb-2">Fields of Applications</h4>
            <p className="text-[#484848]">The wood effect can be applied to windows, furniture, components, appliances, transportation vehicles, sunshades, ships and cars and other decorating materials. It can be furnished according to customer requirements.</p>
          </div>
            {/* Fields of Shapes */}
            <div>
            <h4 className="font-semibold text-[#023D68] mb-2">Shapes</h4>
            <p className="text-[#484848]">The wood pattern can be transferred to all kinds of substrate shapes, including sheets.</p>
          </div>
            {/* Fields of Shapes */}
            <div>
            <h4 className="font-semibold text-[#023D68] mb-2">Aesthetic Value</h4>
            <p className="text-[#484848]">Patterns of the most precious woods, such as oak, chestnut, cherry and walnut, can be imitated.</p>
          </div>
        </div>
      </motion.div>
